...
from sgr_pentest.core.agent_definition import (
    AgentDefinition,
    ExecutionConfig,
    LLMConfig,
    PromptsConfig,
)
from sgr_pentest.core.agent_factory import AgentFactory
from sgr_pentest.core.agents import (
    SGRAgent,
...
def mock_global_config():
    ...
    return patch("sgr_pentest.core.agent_config.GlobalConfig", return_value=mock_config)
...
class TestAgentFactory:
    ...
    async def test_create_agent_from_definition(self):
        ...
        with (
            patch("sgr_pentest.core.agent_factory.MCP2ToolConverter.build_tools_from_mcp", return_value=[]),
            mock_global_config(),
        ):
...
class TestAgentFactoryMCPIntegration:
    ...
    async def test_create_agent_with_mcp_tools(self):
        ...
        with (
            patch(
                "sgr_pentest.core.agent_factory.MCP2ToolConverter.build_tools_from_mcp",
...
class TestAgentFactoryDefinitionsList:
    ...
    def test_get_definitions_list(self):
        ...
        with patch("sgr_pentest.core.agent_factory.GlobalConfig") as mock_global_config:
            mock_config = Mock()
